...
from .models import Category, Customer, Order, CartProduct, Product, Cart
...
class CheckoutView(CartMixin, View):
    ...
    def get(self, request, *args, **kwargs):
        stripe.api_key = "sk_test_51JQ5fZL1ghVWHq2T59aJKIogIMrYiUHRr8gXU3QKZOjXRUEKhkS0CiOEM6oHM91cO8hcGeskREBd8n62b2DesDEa005B1MseuY"
...
class PayedOnlineOrderView(CartMixin, View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        new_order.buying_tpe = Order.BUYING_TYPE_SELF
        new_order.save()
        self.cart.in_order = True
        self.cart.save()
        new_order.cart = self.cart
